...
describe('Testing invalid format receipts', function () {
  ...
  describe('Using eth missing source - 23', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
  ...
  describe('Using eth bad source - 24', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
  ...
  describe('Using eth non hex source - 25', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
  ...
  describe('Using btc missing source - 26', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
  ...
  describe('Using btc non int source - 27', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
  ...
  describe('Using cal missing source - 28', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
  ...
  describe('Using cal bad source - 29', function () {
    var cb = new ChainpointBinary()
    it('should return unable to parse', function (done) {
